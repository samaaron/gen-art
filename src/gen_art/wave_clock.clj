...
(defn mk-lines-stream
  ...
  (let [half-width   (/ (width) 2)
        ...
        x1s          (mul-add radii center-xs cos-rads)
        y1s          (mul-add radii center-ys sin-rads)
        x2s          (mul-add radii center-xs cos-opp-rads)
        y2s          (mul-add radii center-ys sin-opp-rads)
